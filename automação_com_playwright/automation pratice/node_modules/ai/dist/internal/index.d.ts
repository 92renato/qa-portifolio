import { SystemModelMessage, ModelMessage, Tool, ShouldRetryFunction, RetryFunction } from '@ai-sdk/provider-utils';
 ...
 */
declare function prepareRetries({ maxRetries, abortSignal, additionalRetryableError, }: {
